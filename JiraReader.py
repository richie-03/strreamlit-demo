...
class JiraReader(BaseReader):
    ...
    def load_data(self, query: str) -> List[Document]:
        ...
        for issue in relevant_issues:
            ...
            if issue.raw['fields']['customfield_10009'] and issue.raw['fields']['customfield_10009']['showField']:
              epic = issue.raw['fields']['customfield_10009']['data']['summary']

            '''
            issues.append(
                Document(
                    issue.fields.summary + " " + (issue.fields.description or ""), 
                    extra_info={
                      'id': issue.id,
            ...
            issues.append(issue.fields.summary)
